...
app.use(cors({ credentials: true, origin: ["http://localhost:3000", "http://localhost:5173", "https://cektokov1-react.vercel.app"] }))
...
const fileFilter = (req, file, cb) => {
    // const fileExist = fs.readdirSync('images').filter(name => {
